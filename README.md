...
It is a Portfolio website focusing on the following:
    ...
    (1) Contact page - where data are validated both frontend and backend. All persistent data
                           is to be stored in a simple JSON file. Anyone will be able to send a message
